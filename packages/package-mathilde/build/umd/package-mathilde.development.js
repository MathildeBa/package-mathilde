...
(function (global, factory) {
	...
	(global = global || self, factory(global['package-mathilde'] = {}, global.React));
	...
	*/
	...
	var ModalForm = function ModalForm(props) {
	  var children = props.children,
	      ...
	      formProps = objectWithoutProperties(props, ["children", "modalStyle", "formStyle"]);
	...
	var InputButton = function InputButton(props) {
	  var style = props.style,
	      name = props.name,
	      others = objectWithoutProperties(props, ["style", "name"]);

	  return React.createElement(React.Fragment, null, React.createElement("input", _extends_1({
	    type: "button",
	    className: style,
	    value: name,
	    name: name
